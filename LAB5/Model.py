...
class ArbolAVL:
    ...
    def buscar_por_reclutador(self, raiz, nombre_reclutador):
        resultados = []

        if not raiz:
            return resultados

        if raiz.persona.reclutador == nombre_reclutador:
            resultados.append(raiz.persona)

        resultados.extend(self.buscar_por_reclutador(raiz.izquierda, nombre_reclutador))
        resultados.extend(self.buscar_por_reclutador(raiz.derecha, nombre_reclutador))
